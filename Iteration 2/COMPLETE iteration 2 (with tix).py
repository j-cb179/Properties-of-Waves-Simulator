...
tooltips.bind_widget(wlMeter, balloonmsg="This sets the unit of measurement for the wavelength to 'metres'")
tooltips.bind_widget(wlMicro, balloonmsg="This sets the unit of measurement for the wavelength to 'micrometres'")
tooltips.bind_widget(wlNano, balloonmsg="This sets the unit of measurement for the wavelength to 'nanometres'")

tooltips.bind_widget(ampMeter, balloonmsg="This sets the unit of measurement for the amplitude to 'metres'")
tooltips.bind_widget(ampMilli, balloonmsg="This sets the unit of measurement for the amplitude to 'millimetres'")
tooltips.bind_widget(ampMicro,  balloonmsg="This sets the unit of measurement for the amplitude to 'micrometres'")

tooltips.bind_widget(wlOutEntry, balloonmsg="The wavelength is the displacement between one point in a wave, to its next adjacent point")
tooltips.bind_widget(ampOutEntry,balloonmsg="Amplitude is the displacement of the two further particles by a wave from a node to an antinode" )
tooltips.bind_widget(velOutEntry, balloonmsg="The velocity of the wave is the how many metres it can travel in 1 second")
tooltips.bind_widget(freqOutEntry, balloonmsg="The frequency of a wave is how many times a wavelength passes through a single point in a second")
tooltips.bind_widget(energyOutEntry, balloonmsg="The photon energy of a wave is the amount of energy carried per photon of the wave in electronvolts")
tooltips.bind_widget(periodOutEntry, balloonmsg="The time period of a wave is the amount of time it takes to complete a radian cycle (360 degrees when modelled on a 2d plane circle)")

tooltips.bind_widget(redLightRadioB, balloonmsg="These are the example measurements of a red light wave from the EM spectrum")
tooltips.bind_widget(blueLightRadioB, balloonmsg="These are the example measurements of a blue light wave from the EM spectrum")
tooltips.bind_widget(gammaWaveRadioB, balloonmsg="These are the example measurements of a gamma wave from the EM spectrum")
tooltips.bind_widget(microWaveRadioB, balloonmsg="These are the example measurements of a microwave from the EM spectrum")
tooltips.bind_widget(customWaveRadioB, balloonmsg="wavelength = 10, velocity = 1, frequency = 0.1, amplitude = 1")
